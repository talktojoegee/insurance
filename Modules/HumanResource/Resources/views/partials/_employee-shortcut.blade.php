    ...
    <div class="col-xl-12 col-lg-12  filter-bar">
        <nav class="navbar navbar-light bg-faded m-b-30 p-10">
            <div class="nav-item nav-grid">
                ...
                <a href="javascript:void(0);" data-toggle="modal" data-target="#permissionModal" class="btn btn-warning btn-mini waves-effect waves-light"><i class="ti-lock mr-2"></i>Access Level</a>
