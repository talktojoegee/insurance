...
@section('event-area')
    <div class="btn-group">
        ...
        <a class="btn btn-primary btn-mini" href="{{route('create-chart-of-account')}}"><i class="icofont icofont-tasks"></i>Add New Account</a>
    </div>
@endsection
        ...
        <div class="col-xl-12 col-lg-12  filter-bar">
            <nav class="navbar navbar-light bg-faded m-b-30 p-10">
                <div class="nav-item nav-grid">
                    <a href="{{ route('chart-of-accounts') }}" class="btn btn-primary btn-mini waves-effect waves-light"><i class="ti-plus mr-2"></i>Chart of Accounts</a>
                </div>
            </nav>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 offset-md-2 offset-lg-2 offset-sm-2">
            <div class="card">
                <div class="card-block">
                    ...
                    @endif
                    <form autocomplete="off" action="{{route('save-account')}}" method="post">
                        @csrf
                        <div class="row">
