<nav class="side-nav">
    <a href="" class="intro-x flex items-center pl-5 pt-4">
        <img alt="BWIB - Insurance application" class="w-6" src="/dist/images/logo.svg">
    ...
    <ul>
        ...
        <li>
            <a href="javascript:;" class="side-menu">
                ...
                <div class="side-menu__title"> Policy <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
            </a>
            <ul class="">
                <li>
                    <a href="index.html" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="truck"></i> </div>
                        <div class="side-menu__title"> Motor </div>
                    </a>
                </li>
                <li>
                    <a href="simple-menu-light-dashboard.html" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="side-menu__title"> Non-motor </div>
                    </a>
                </li>
                <li>
                    <a href="simple-menu-light-dashboard.html" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="settings"></i> </div>
                        <div class="side-menu__title"> Policy Settings </div>
                    </a>
                </li>
            </ul>
        </li>
        <li>
            <a href="index.html" class="side-menu side-menu">
                <div class="side-menu__icon"> <i data-feather="users"></i> </div>
                <div class="side-menu__title"> Debit Notes </div>
            </a>
        </li>
        <li>
            <a href="index.html" class="side-menu side-menu">
                <div class="side-menu__icon"> <i data-feather="users"></i> </div>
                <div class="side-menu__title"> Credit Note </div>
            </a>
        </li>
        <li>
            <a href="index.html" class="side-menu side-menu">
                <div class="side-menu__icon"> <i data-feather="users"></i> </div>
                <div class="side-menu__title"> Claim </div>
            </a>
        </li>
        <li>
            <a href="javascript:;" class="side-menu">
            ...
            <ul class="">
                <li>
                    <a href="index.html" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="side-menu__title"> Debit Note </div>
                    </a>
                </li>
                <li>
                    <a href="simple-menu-light-dashboard.html" class="side-menu">
        ...
        <li>
            <a href="javascript:;" class="side-menu">
                ...
                <div class="side-menu__title"> Administration <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
            </a>
            <ul class="">
                <li>
                    <a href="{{url('human-resource/add-new-employee')}}" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="user-plus"></i> </div>
                        <div class="side-menu__title"> Add New Employees </div>
                    </a>
                </li>
                <li>
                    <a href="{{url('human-resource')}}" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="tool"></i> </div>
                        <div class="side-menu__title"> Manage Employees </div>
                    </a>
                </li>
                <li>
                    <a href="{{url('human-resource/settings')}}" class="side-menu">
                        <div class="side-menu__icon"> <i data-feather="settings"></i> </div>
                        <div class="side-menu__title"> HR Settings </div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="{{url('company-settings/general-settings')}}" class="side-menu">
                <div class="side-menu__icon"> <i data-feather="settings"></i> </div>
